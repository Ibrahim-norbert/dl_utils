...
if __name__ == "__main__":
    ...
    cwd = Path(r"C:\Users\imansaray\repos\SuperRes-Imperial-CNRS\data")

    # dataDirs = [
    #     cwd / r"ARI-and-IoU-cluster-analysis-evaluation-main\Ground Truth - Scenario 5",
    #     cwd / r"ARI-and-IoU-cluster-analysis-evaluation-main\Ground Truth - Scenario 6",
    #     cwd / r"ARI-and-IoU-cluster-analysis-evaluation-main\Ground Truth - Scenario 8",
    #     cwd / r"ARI-and-IoU-cluster-analysis-evaluation-main\Ground Truth - Scenario 9",
    # ]

    d: Path = cwd / r"testingRealData\summarised"

    dataDirs: List[str] = [
        r"C:\Users\imansaray\repos\SuperRes-Imperial-CNRS\data\RealData-Florian-30.10.2025\rings"
    ]
    datasetPath: str = SMLMDataset.dir2CSV(dataDirs=dataDirs, save_dir=d)

    dataCol: str = "filePath"

    label_col: str = "filePath"

    d = SMLMDataset(
        dataCol=dataCol,
        datasetPath=datasetPath,
        dataPointCol=label_col,
        verticesInstanceLabelCol="index",
        verticesCol=["x[pix]", "y[pix]"],
    )
    o: Localizations = d.__getitem__(1)

    print(
        [
            f"We have for {o.__class__} shape {x.shape}"
            for x: Data | str in o
